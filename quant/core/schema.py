...
CREATE_TABLE_SQL: tuple[str, ...] = (
    ...
    CREATE TABLE IF NOT EXISTS quant.quant_backtest_parameters (
        ...
        execution_price_mode TEXT NOT NULL DEFAULT 'DEPTH',
...
ALTER_TABLE_SQL: tuple[str, ...] = (
    ...
    "ALTER TABLE quant.quant_backtest_parameters ADD COLUMN IF NOT EXISTS execution_price_mode TEXT NOT NULL DEFAULT 'DEPTH'",
