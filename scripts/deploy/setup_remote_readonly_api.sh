...
POLYDATA_API_POSTGRES_POOL_SIZE=${GUNICORN_THREADS}
POLYDATA_API_POSTGRES_POOL_ACQUIRE_TIMEOUT_SECONDS=15
POLYDATA_API_POSTGRES_POOL_CONNECT_ATTEMPTS=3
POLYDATA_API_POSTGRES_POOL_CONNECT_RETRY_DELAY_SECONDS=0.25
